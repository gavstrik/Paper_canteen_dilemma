...
\newenvironment{tobo}{\smallskip \noindent \color{black!60!green!70}}{\color{black}\smallskip}
...
\begin{tobo} Lægger vi ikke ordet i munden på folk? Vi kan jo ikke være sikker på hvad der ligger bag kommentaren?
 \end{tobo}
...
\begin{tobo}
Jeg foreslår at vi i selve artiklen diskuterer de tidligere varianter af spillet, og så refererer vi her i stedet til disse nye tilføjede diskussioner. Altså: Det som Nicolet skriver ovenfor skal ekspanderes og gøres til en del af den reviderede submission.
\end{tobo}
