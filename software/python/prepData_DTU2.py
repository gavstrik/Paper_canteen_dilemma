...
datafiles = [
             '../RawData/DTU2/all_apps_wide_2019-04-23.csv',
            ]
...
# save
# df.to_csv('../data/DTU2_allcd.csv')
# df.to_excel('../data/DTU2_allcd.xlsx')
df = df.drop(['turker'], 1)
df.to_csv('../data/DTU2_anonymous.csv')
df.to_excel('../data/DTU2_anonymous.xlsx')
