...
\begin{abstract}
Common knowledge is a crucial for safe group coordination. In its absence, %When common knowledge cannot be obtained, 
...
In three separate experiments involving 802 participants, we investigate the extend to which humans %are able to recognize the difference 
...
However, this fact can not become common knowledge %is impossible to achieve 
