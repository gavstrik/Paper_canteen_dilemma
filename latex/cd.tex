...
We suggest that our game design constitutes an important methodological advancement in the field of cognitive science due to its ability to replace complicated experimental explications of who knows what with asynchronous arrival times. It reduces experimental error and increases paradigmatic flexibility. We believe that our contribution goes well beyond a methodological advance, however. Our main theoretical contribution is that non-explicated higher order shared knowledge is wrongly treated as common knowledge in any realistic setting where humans can't (or won't) communicate freely, even when they \emph{could deduce} that common knowledge is unattainable. This means, informally, that bottom-up sensory stimuli ("the time is before 9 am") \emph{wins the perception battle} over top-down conceptual knowledge ("she could think that I think that she thinks ..."). And this is the case despite repeated error signals. We are confident that this is of theoretical importance for various subfields within the cognitive sciences such as predictive processing~\citep{hinton2007learning, palmer2015felt}, stigmeric coordination~\citep{heylighen2016stigmergyI, heylighen2016stigmergyII}, multi-robot and human-computer system designs~\cite{nebel2019implicitly}, as well as for theories of the mind~\footnote{It should be noted that recursive games do exist in the ToM literature, see for instance~\citep{hedden2002you, flobbe2008children, curry2012putting}. Our purpose, however, is not to determine whether players can distinguish $n$th order and $(n+1)$th order shared knowledge, but whether players can in general distinguish shared knowledge (of some order) from common knowledge.}.

We believe that our results also may be of practical interest for legislative efforts trying to create social rules of conduct in situations where coordination without explicit communication is common. As an example, we can mention the recent changes in global legislations on rape and sexual assault: within the last 20 years, more than 30 countries globally have shifted or are in the process of shifting from a coercion-based model, which requires that for a sexual act to be considered rape there needs to be proof of coercion, to a consent-based model, which stipulates that sex without mutual consent is to be considered as rape. The main reason for this change is that rape and sexual assault often occurs in situations where friends or partners miscoordinate their signals and become unable and/or unwilling to change their behavior~\citep{mcgregor2017rape, amnesty2018yes, koljonen2019how, wikipedia2021sexual}. In other words, sexual consent law frequently deals with ambiguous coordination problems where shared knowledge has been wrongly interpreted as being common knowledge.\footnote{Imagine the following experimental design: instead of trying to meet for a cup of coffee, we ask participant-pairs to try to interpret their behavioral signals ("she/he asks you to sit next to her/him", "he/she touches you", etc..) as being either romantic invitations or embarrassing intrusions. The question then becomes: at which point may a sexual advance be permissible, if ever? If only one of them is interested, it is cleary wrong to make a move. If both of them are interested, they still only have private knowledge and do not know whether the other is interested as well, in which case making a move is very risky. If both have first order shared knowledge (i.e. they both know that the other is interested) they still may see it possible that the other player only has private knowledge (see Fig.~\ref{fig:indistinguish}), in which case it again is best not to make a move because of the risk of the other player thinking that you are not interested. The point, of course, is that this can be generalized in the same way as in our game. As long as there is no explicit consent by which the players create common knowledge, they can never be completely sure whether their partner will feel harrassed or not.}. 

The wider implications, supported by our findings, are clear: If we do not take seriously the fact that we often are unable to properly distinguish between common knowledge and shared knowledge, we cannot hope to mitigate the harmful effects arising from it. That is, players in our game might not appreciate the importance of a public announcement that they both arrived before 9:00 (something they already know if arriving before 8:50), but will run into miscoordination without it. Our results therefore show the importance of emphasizing open and honest communication, even when not intuitively necessary, in situations where it matters. 
