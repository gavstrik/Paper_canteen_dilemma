...
because any finite-order knowledge attribution allows for an even higher order attribution that may change what is known by whom. \re{I have reversed the deletion of this explanation. Please tell why it was removed?!}
...
can differentiate between common knowledge and nth-order shared knowledge. We %have 
designed a two-person coordination game with imperfect information to simplify the %that is able to cast the 
recursive game structure and higher-order uncertainties into a reliable, everyday scenario. 
...
in the game. The fact can at most be nth-order shared knowledge for some n.
...
However, this raises a broader question: even if people make other strategic choices when explicitly informed about %depending on whether they have shared or common 
...
reveal a curse of shared knowledge, as we conjecture, this is a somewhat surprising result. In most cases, bounded rationality and non-logical omniscience of agents lead them to %be able to conclude less 
...
From studies on coordination, particularly the coordinated attack problem~\citep{fagin1995reasoning}, we know that successful coordination generally requires common knowledge~\citep{moses2016relating}, %and in many cases, common knowledge cannot be achieved. 
