...
We believe that our results may also be of practical interest for legislative efforts trying to create social rules of conduct in situations where coordination without explicit communication is common. As an example, we can mention the recent changes in global legislations on rape and sexual assault: within the last 20 years, more than 30 countries globally have shifted or are in the process of shifting from a coercion-based model, which requires that for a sexual act to be considered rape there needs to be proof of coercion, to a consent-based model, which stipulates that sex without mutual consent is to be considered as rape. The main reason for this change is that rape and sexual assault often occurs in situations where friends or partners miscoordinate their signals and become unable and/or unwilling to change their behavior~\citep{mcgregor2017rape, amnesty2018yes, koljonen2019how, wikipedia2021sexual}. In other words, sexual consent law frequently deals with ambiguous coordination problems where shared knowledge has been wrongly interpreted as being common knowledge. Imagine the following experimental design: instead of trying to meet for a cup of coffee, we ask pairs of participants to try to interpret their behavioral signals ("she/he asks you to sit next to her/him", "he/she touches you", etc..) as being either romantic invitations or embarrassing intrusions. The question then becomes: at which point may a sexual advance be permissible, if ever? If only one of them is interested, it is clearly wrong to make a move. If both of them are interested, they still only have private knowledge and do not know whether the other is interested as well, in which case making a move is very risky. If they have first-order shared knowledge (i.e.\ they both know that the other is interested), they still may see it possible that the other player only has private knowledge (see Fig.~\ref{fig:indistinguish}), in which case it again is best not to make a move because of the risk of the other player thinking that you are not interested. The point, of course, is that this can be generalized in the same way as in our game. As long as there is no explicit consent by which the players create common knowledge, they can never be completely sure whether their partner will feel harassed or not.
