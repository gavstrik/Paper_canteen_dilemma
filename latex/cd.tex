...
\begin{figure} %[t]
  ...
  \caption{Logistic regression of the relationship between card number and choice of a white stone in the qualitative experiment at DIS. The resulting curve shows a similar behavior as in the main experiments shown in figure 1.}
  \label{fig:dis}
  \end{figure}  
